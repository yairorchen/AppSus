export default {
  template: `
        <header class="mail-header-section flex align-center justify-end">
        <div>
            <img src="https://cdn-icons-png.flaticon.com/512/17/17704.png" class="candy-box-menu" @click="toggleMenu()" >
            <nav v-if="menuOpen" class="menu-modal">
                ...
                <router-link to="/mail" @click="toggleMenu()"><h1>Mails</h1></router-link> 
